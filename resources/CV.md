...
fpalero1986@gmail.com | +49 176 81268878 | Alemania
...
- **Programming & Architecture**: Java, Python, Spring Boot, Spring Cloud, Microservices, Modular Architecture, SOLID, DDD, Hexagonal Architecture, REST APIs, Kafka, Prisma.
- **Databases & Cloud**: PostgreSQL, MongoDB, AWS (ECS, EC2, S3), Azure (Event Hub, Cosmos DB, Functions, Azure Authorization), Nextcloud, Appsmith.
- **Frontend, Mobile & Tools**: Angular, React, EmberJS, TypeScript, JavaScript, Android SDK, Docker, Docker Compose, Devcontainer, GitHub Actions, GitFlow, CI/CD.
- **Methodologies & Testing**: Agile, Scrum, Test-Driven Development (TDD), Automation Testing, PyTest, Jasmine, Karma, Selenium, JUnit, Mockito, Cypress.
- **Leadership**: Technical Mentorship, Cross-Functional Leadership, Architecture Governance, Code Reviews.

## PROFESSIONAL EXPERIENCE

### Senior Software Engineer | Material One | Remote, Germany
...
### Software Engineer Team Lead | Saitow AG (Alzura) | Spain
...
- Guaranteed application robustness through extensive automated test suites using JUnit, Mockito, and Cypress.

### Software Analyst | Backend Developer | Koukio | Spain
...
### Software Analyst | Backend Developer | Sopra Steria | Spain
...
### Project Manager | Telefónica | Spain
...
### Lead AI Engineer & Full-Stack Developer | Open-Source Intelligent Applications | Personal Portfolio
*January 2026 – Present*
- **Automated Order Management Chatbot**: Conceptualized and built an autonomous conversational agent utilizing Python, LangChain, and local LLMs to handle commercial orders. Developed the frontend layout with Angular and TypeScript, leveraging Appsmith for rapid internal tool orchestration and Nextcloud for secure cloud file management. Integrated a robust data layer with Prisma managing a PostgreSQL database. Containerized the entire infrastructure using Docker, Docker Compose, and Devcontainers, automating cloud deployment to AWS EC2 instances. Guaranteed system stability using Python testing libraries (PyTest/Unittest) and Angular testing frameworks (Jasmine/Karma) to achieve full pipeline automation.
- **Multi-Agent Personal Coach & Trainer Platform**: Engineered a sophisticated multi-agent system using LangGraph, LangChain, and LlamaIndex for semantic RAG data retrieval. Built the full-stack user interface with Angular, TypeScript, and Appsmith, utilizing Nextcloud and AWS S3 to store and sync raw multimedia athlete data. Designed a dual-database architecture using Prisma with PostgreSQL for transactional user metrics and MongoDB for unstructured fitness data analytics. Standardized the development workflow via Devcontainers and Docker Compose pipelines, ensuring cross-environment application reliability through comprehensive automated testing suites across Python and Angular.
- **IPSF Sports Advisor**: Designed a specialized regulatory compliance assistant for international pole sports athletes, powered by Claude and running on a multi-agent framework with LangGraph, LangChain, and LlamaIndex. Architected the full-stack application using Angular and TypeScript for the user interface, Appsmith for dashboard visualization, and Nextcloud for document federation. Managed rulebook validation structures using Prisma connected to MongoDB and PostgreSQL instances. Deployed the containerized application on scalable AWS container services using Docker, validating system behavior through automated Python and Angular test matrices.
...
## EDUCATION
- **Master of Science (M.Sc.) – ICT Research** | Autonomous University of Madrid, Spain
- **Bachelor of Science (B.Sc.) – Computer Science Engineering** | Polytechnic University of Valencia, Spain
