...
from core.extractor_repository import store_results
from core.data_unified_repository import store_unified_results
...
def run_ingestion(resources, sources):
    for source in sources:
        ...
        for target in config["targets"]:
            ...
            if results:
                source_label = "LinkedIn" if source.lower() == "linkedin" else source.capitalize()
